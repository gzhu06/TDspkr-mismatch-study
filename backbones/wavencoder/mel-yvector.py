...
from backbones.wavencoder.frontend_utils import DSTCNBlock, ConvDS
...
#         self._window_stride = int(sample_rate * window_stride // 1000)
    ...
    def forward(self, inputs):
        ...
        """
        outputs = self.stft.mel_spectrogram(inputs)
        return outputs
...
class architecture(nn.Module):
    def __init__(self, 
        ...
        self.melfbank = MelFilterbanks(n_filters=n_filters)
        self.convds = ConvDS(ds_layers=ds_layers, in_dim=n_filters)
